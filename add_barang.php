...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
  ...
  <!-- KONTEN BODY AWAL -->
    ...
    $kode=$nama=$hargabeli=$hargajual=$keterangan=$kategori=$deposit=$brand="";
    $no = $_GET["no"];
    $insert = '1';
   ...
   <div class="container-fluid">
              ...
              <div class="box-body">
                ...
                <div class="row">
                        <div class="form-group col-md-6 col-xs-12" >
                          ...
                          <div class="col-sm-9">
                           <?php  if($no == null || $no ==""){ ?>
                            <input type="text" class="form-control" name="sku" value="SKU<?php echo autoNumber(); ?>" maxlength="50" required>
                          <?php }else{ ?>
                     <input type="text" class="form-control" name="sku" value="<?php echo $sku; ?>"  required readonly>
                  <?php } ?>
                  </div>
                        </div>
                </div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="hargajual" name="hargajual" value="<?php echo $hargajual; ?>" placeholder="Masukan Harga Jual" maxlength="20">
                  </div>
                </div>
        </div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="hargabeli" name="hargabeli" value="<?php echo $hargabeli; ?>" placeholder="Masukan Harga Beli" maxlength="20">
                  </div>
                </div>
        </div>
      ...
      ?>
          ...
          <div class="row">
                        <div class="form-group col-md-6 col-xs-12" >
                          <label for="kode" class="col-sm-3 control-label">Stok Minimal:</label>
                           <div class="col-sm-9">
                             <?php  if($no == null || $no ==""){ ?>
                ...
                <div class="row">
                        <div class="form-group col-md-6 col-xs-12" >
                          <label for="sisa" class="col-sm-3 control-label">Stok barang:</label>
                          <div class="col-sm-9">
                           <?php  if($no == null || $no ==""){ ?>
                            <input type="text" class="form-control" id="sisa" name="sisa" value="1" required>
                          <?php }else{ ?>
                     <input type="text" class="form-control" name="sisa" value="<?php echo $sisa; ?>"  placeholder>
                  <?php } ?>
                  </div>
                        </div>
                </div>
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          if($chmod >= 3 || $_SESSION['jabatan'] == 'admin'){
                  $sql1 = "update $tabeldatabase set sku='$sku', nama='$nama', hargabeli='$hargabeli', hargajual='$hargajual', kategori='$kategori',  stokmin='$min', brand='$brand', keterangan='$keterangan' where kode='$kode'";
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
           ...
           $sql2 = "insert into $tabeldatabase values( '$kode','$sku','$nama','$hargabeli','$hargajual','$keterangan','$kategori','','','','','$min','$brand')";
