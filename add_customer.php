...
$dataapa = "Customer"; // data apa
$tabeldatabase = "customer"; // tabel database
...
$insert = $_POST['insert'];
 ...
 function autoNumber(){
  ...
  global $forward;
  $query = "SELECT MAX(RIGHT(kode, 5)) as max_id FROM $forward ORDER BY kode";
   ...
   <div class="container-fluid">
        ...
        <div class="row">
                <div class="form-group col-md-6 col-xs-12" >
                  <label for="kode" class="col-sm-3 control-label">Kode Customer:</label>
                  <div class="col-sm-9">
                   <?php  if($no == null || $no ==""){ ?>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  <label for="tgldaftar" class="col-sm-3 control-label">Tanggal Bergabung:</label>
                  <div class="col-sm-9">
